...
import ba.unze.elearning.tutoring.Entities.Embeddeds.GroupMessageId;
import ba.unze.elearning.tutoring.Entities.GroupMessage;
import ba.unze.elearning.tutoring.Entities.User;
import ba.unze.elearning.tutoring.Repositories.DirectMessageRepository;
import ba.unze.elearning.tutoring.Repositories.UserRepository;
import ba.unze.elearning.tutoring.Security.JwtUtil;
import ba.unze.elearning.tutoring.Services.MessageService;
...
//        }
//
//        List<ba.unze.elearning.tutoring.Entities.GroupMessage> messages = messageService.getOldGroupMessages(groupId, page, size);
//        return ResponseEntity.ok(messages);
//    }
//
