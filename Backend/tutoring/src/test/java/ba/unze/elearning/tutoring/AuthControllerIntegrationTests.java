package ba.unze.elearning.tutoring;
...
class AuthControllerIntegrationTests {
    ...
    void setup() {
        ...
        User user = new User("testuser", passwordEncoder.encode("testpass123"), "Test", "User", "test@test.local", "000111222", AccountType.STUDENT);
